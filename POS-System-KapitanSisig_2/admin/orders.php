        ...
        <?php
            ...
            if($orders){
                if(mysqli_num_rows($orders) > 0){
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#placedOrders">Active</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#preparingOrders">Link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#completedOrders">Link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#cancelledOrders" tabindex="-1" aria-disabled="true">Disabled</a>
                    </li>
                    </ul>
                    ...
                    <div id="placedOrders">
                        ...
                        <div class="mt-2">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php foreach(array_reverse($placedOrders) as $orderItem): ?>
                                        <tr>
                    ...
                    <div id="preparingOrders">
                        ...
                        <div class="mt-4">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php foreach(array_reverse($preparingOrders) as $orderItem): ?>
                                        <tr>
                                            <td class="fw-bold"><?= $orderItem['tracking_no']; ?></td>
                                            <td><?= $orderItem['name']; ?></td>
                                            <td><?= $orderItem['order_date']; ?></td>
